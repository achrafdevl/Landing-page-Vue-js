...
<template>
    <footer>
        <div class="container">
            <div>
                <svg width="46" height="40" class="text-blue-900 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <div>
                    <a href="#"
                        v-for="link in 4"
                        :key="link"
                        class="text-white text-opacity-58 hover:text-opacity-100 transition-opacity duration-150"
                    >
                    Link {{ link }}
                    </a>
                </div>
            ...
            <div>
                <label>
                    <input
                        ...
                        class="bg-gray-800 bg-opacity-50 rounded-lg py-3 px-4 text-white text-opacity-50 focus:outline-none focus:"
                    />
                </label>
                <button
                    type="button"
                    class="ml-4 ру-3 px-6 bg-white rounded-lg text-gray-880 font-bold hover:bg-gray-100 transition-colors duration
"
                >
                   Send
                </button>
